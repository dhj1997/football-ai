                ...
                settlement = self.repository.save_fixture_settlement(
                    {
                        ...
                        **clv_data,
                        ...
                        "data_source": fixture.get("source") or fixture.get("result_source"),
                        "bet_id": bet.get("id") if bet else None,
                        "execution_id": bet.get("execution_id") if bet else None,
                        "execution_status": "SETTLED" if bet and bet.get("status") == "settled" else None,
