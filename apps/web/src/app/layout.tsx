  ...
  return (
    <html lang="zh-CN" suppressHydrationWarning>
      <body>
        ...
        />
        <header className="sticky top-0 z-50 flex items-center justify-between gap-4 border-b border-slate-800 bg-pitch-900/90 px-6 py-3 backdrop-blur-md">
          <div className="flex items-center gap-5">
            ...
            <div className="hidden items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-1 text-xs text-emerald-400 md:flex">
